import os, ctypes
from ctypes import c_int, c_uint, c_bool, c_float, c_char, c_char_p, POINTER, byref
...
_lib = ctypes.CDLL(os.path.join(sPath, 'DLL_win64', 'vnx_fmsynth'))
...
# fnLMS_GetModelName = getDllObject('fnLMS_GetModelNameW', [DEVID, STRING], restype=c_int)
